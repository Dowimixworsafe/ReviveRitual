...
public final class ReviveMe extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("reviveme").setExecutor(new ReviveMeCommand(this, configManager, dataManager, revivalManager, punishmentManager));
    ...
    public void onDisable() {
        ...
        if (ghostManager != null) ghostManager.removeAllGhosts();
    }
